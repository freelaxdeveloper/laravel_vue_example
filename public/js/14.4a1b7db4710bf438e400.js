...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    twitch: function twitch() {
      ...
      window.location.href = "/twitch/login?is_streamer=" + (this.is_streamer ? 1 : 0);
    }
  },
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _c("v-switch", {
                        attrs: { label: "Войти как " + _vm.label },
                        model: {
                          value: _vm.is_streamer,
                          callback: function($$v) {
                            _vm.is_streamer = $$v
                          },
                          expression: "is_streamer"
                        }
                      }),
                      _vm._v(" "),
                      _c("login-twitch", {
                        attrs: { is_streamer: _vm.is_streamer }
                      })
                    ],
                    1
                  )
